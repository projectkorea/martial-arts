...
export const initShareData = (): void => {
...
export const shareKakaoPersonalResult = (): void => {
  Kakao.Link.createDefaultButton({
    container: '#btnKakao2',
    objectType: 'feed',
    content: {
