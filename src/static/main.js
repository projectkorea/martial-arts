...
/* harmony import */ var _start__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./start */ "./src/assets/js/start.js");
...
/* harmony import */ var _question__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./question */ "./src/assets/js/question.js");
/* harmony import */ var _result__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./result */ "./src/assets/js/result.js");
...
/* harmony import */ var _value__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./value */ "./src/assets/js/value.js");
/* harmony import */ var _value__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_value__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony export */   "quest": function() { return /* binding */ quest; }
/* harmony export */ });
var quest = {
  1: {
  ...
  6: {
    "title": "<span class='half_HL'>강력해 보이는 몬스터</span>를<br> 봤을 때 나는",
    "A": {
      "text": "일단 좀 맞자. 때려본다.",
      "type": "P"
    },
...
var TITLE, DESCRIPTION, imgURLKakao, myURLKakao, EXPLANNATION;
...
var shareKakaoMyData = function shareKakaoMyData() {
  ...
  Kakao.Link.createDefaultButton({
    ...
    objectType: "feed",
    content: {
      title: _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_0___default()(_context = "\"".concat(TITLE, "\": ")).call(_context, DESCRIPTION),
...
var init = function init() {
  ...
  folderBtnDown.onclick = function () {
